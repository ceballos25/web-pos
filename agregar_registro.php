  ...
  <div class="alert alert-dismissible fade show" role="alert">
    <div class="d-flex">
      <div class="me-3">
        ...
        <input type="text" id="totalProductos" name="totalProductos" class="form-control" value="' . $cantidadFinal . '" readonly>
      </div>

      <div>
        <label for="totalPagar"><strong>Total a Pagar:</strong></label>
        <input type="text" id="totalPagar" name="totalPagar" class="form-control" value="$' . number_format($totalPrecio, 0, ',', '.') . '" readonly>
      </div>
    </div>
  </div>
</div> </td>';
